    ...
    <main class="wrapper">
                            ...
                            <div class='row'>
                                <div class='col-md-6 mb-3'>
                                    <div class='form-group'>
                                        ...
                                        <input type='text' style="min-width: 200px;" name='keyphrase' class='form-' placeholder="Keyphrase to rank for eg Fish farming" required>
                                    </div>
                                </div>
                                <div class='col-md-6 mb-3'>
                                    <div class='form-group'>
        ...
        <script>
            ...
            titleInput.addEventListener('input', (e) => {
                ...
                slug = slug.replace(/^-+|-+\$/g, ''); //clean any trailing /

                if (slugInput) slugInput.textContent = `/${slug} == ${slug.length}`;
            });
